...
import videowalk from '../../assets/video/walkthrogh.mp4';
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col justify-center lg:justify-start items-center w-full h-full pt-0 lg:pt-10">
                ...
                {/* Page Title */}
                <h1 className="text-2xl md:text-3xl  lg:text-5xl font-bold text-white tracking-wide mb-4 md:mb-10 drop-shadow-lg z-10 select-none">
                    Walkthrough
                </h1>
